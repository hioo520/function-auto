package top.hihuzi.function.service;
...
import top.hihuzi.function.annotation.Get;
 ...
 * tips function-auto
 *
 * @author hihuzi 19 9:21
 */
@SupportedAnnotationTypes("top.hihuzi.function.annotation.Get")
...
public class GetProcessor extends AbstractProcessor {
    ...
    public synchronized boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        Set<? extends Element> set = roundEnv.getElementsAnnotatedWith(Get.class);
        set.forEach(element -> {
